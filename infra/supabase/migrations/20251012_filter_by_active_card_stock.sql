-- Migration: Add is_active parameter to get_card_stock function
-- File: supabase/migrations/YYYYMMDDHHMMSS_add_active_filter_to_get_card_stock.sql

-- Drop old version (to allow signature change: params + return type)
DROP FUNCTION IF EXISTS public.get_card_stock(UUID, UUID);

-- Create new version with is_active parameter
