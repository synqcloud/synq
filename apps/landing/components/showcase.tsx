      ...
      >
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          ...
          <div className="space-y-16">
            ...
            {/* Library Showcase - Interactive Component */}
            <motion.div
              className="flex flex-col lg:flex-row lg:items-start lg:gap-12 border border-border rounded-lg p-8 shadow-sm bg-card"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="lg:w-1/2 lg:flex-1">
                ...
                <p className="text-base font-light tracking-[-0.01em] text-muted-foreground mb-8 leading-relaxed">
                  Access comprehensive card databases for multiple TCGs. Import
                  card data, track collections, and create custom libraries for
                  your specific product groups.
                </p>
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
                  We're building Synq with real card shops and sellers. Try it
                  out and tell us how Synq helps you handle your collectibles
                  business better.
                </p>
              </div>
